...
#define DRIVER_NAME "ioctl_module"
...
static ssize_t test_ioctl_read(struct file *filp,
			       char __user *buf,
			       size_t count,
			       loff_t *f_pos
	) {
...
static int __init ioctl_init(void) {
	...
	ret = cdev_add(&ioctl_cdev, dev, dev_num);
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Testing ioctl");
